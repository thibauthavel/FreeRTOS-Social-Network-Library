...
Then, I tested the main functions using the resulted entities (\cfunction{twitterAuthEntity} and \cfunction{tweet}) and trying to make it crash: for instance, by specifying wrong parameters.
